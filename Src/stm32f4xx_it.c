...
extern uint8_t USART_VAL;

extern uint32_t USART_TC_MASK;   	      // TC - 6 bit
extern uint32_t USART_TXE_MASK;   	  // TXE - 7 bit
/* USER CODE END PM */
...
extern uint32_t ADC1_JDR2;
extern uint32_t ADC1_VREF;
